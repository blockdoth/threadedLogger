...
public class LogBuilder {
    ...
    private  int columnWidth = 17;
    private  int doubleColumnWidth = 2 * columnWidth;
    ...
    private  String progressBar(int finished, int totalCount, int columnWidth) {
        ...
        float progress = (float) finished / (float) totalCount;
    ...
    private  String centerBetween(String string, String delimiter, int width) {
        ...
        StringBuilder centeredStringBuilder = new StringBuilder(width);

        centeredStringBuilder.append(delimiter);
        centeredStringBuilder.append(" ".repeat(Math.max(0, (width - stringLength) / 2)));
        centeredStringBuilder.append(string);
        centeredStringBuilder.append(" ".repeat(Math.max(0, (width - stringLength + 1) / 2)));
        return centeredStringBuilder.toString();
    }
